...
class TestRoom(unittest.TestCase):
    ...
    def test_remove_person_from_room(self):
        self.room1.check_before_add_to_guest_list(self.guest1)
        self.room1.remove_from_guest_list(self.guest1)
        self.assertEqual(0, len(self.room1.guest_list))

    def test_get_guest_list_length(self):
        self.room1.check_before_add_to_guest_list(self.guest2)
    ...
    def test_cannot_add_guests_to_room(self):
        self.room2.check_before_add_to_guest_list(self.guest1)
        self.room2.check_before_add_to_guest_list(self.guest2)
